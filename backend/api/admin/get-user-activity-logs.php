...
try {
    ...
    15,16: Auction Deliver (farm, win)
    17: Bids (cust)
    */
    ...
    $stmt->execute([
        ...
        // $userId, // Orders (5 - Reassigned Order) **REMOVED**
        $userId, // Auction Tracking (1 - Farmer)
        $userId, // Auction Tracking (2 - Agent)
        $userId, // Auction Tracking (3 - Comment wildcard)
        // Winner ID removed from Auction Tracking
        // $userId, // Auction Tracking (5 - Reassigned Auction) **REMOVED**
        ...
        // Farmer ID removed from Auction Pay
        // Shipped/Delivered blocks commented out
        $userId, // Bids (1)
