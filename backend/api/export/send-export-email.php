...
if (!function_exists('sendExportStatusEmail')) {
    function sendExportStatusEmail(array $params): bool {
        ...
        $subject = "[$expRef] Export Request Updated — $label | Caravan of Flavours";
...
<body style='margin:0;padding:0;background:#f8fafc;font-family:Arial,sans-serif;'>
  <div style='max-width:560px;margin:32px auto;background:white;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);'>
    ...
    <div style='background:linear-gradient(135deg,#FF7E21 0%,#e65c00 100%);padding:32px;text-align:center;'>
      <h1 style='color:white;margin:0;font-size:22px;letter-spacing:-0.02em;'>🌍 Caravan of Flavours</h1>
    ...
    <div style='padding:32px;'>
      ...
      <p style='font-size:12px;color:#94a3b8;line-height:1.6;margin:0;'>
        You can log in to the Caravan of Flavours platform to view the full details and track the complete history of this export request.
      </p>
    </div>
    <!-- Footer -->
    <div style='background:#f8fafc;padding:16px 32px;border-top:1px solid #e2e8f0;text-align:center;'>
      <p style='margin:0;font-size:11px;color:#94a3b8;'>© " . date('Y') . " Caravan of Flavours. Automated notification — please do not reply.</p>
    </div>
  </div>
</body>
</html>";
        ...
        $headers .= "From: Caravan of Flavours <noreply@caravanofflavours.com>\r\n";
